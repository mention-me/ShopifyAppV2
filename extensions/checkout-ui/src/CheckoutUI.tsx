...
const CheckoutUI = () => {
    ...
    const {
        ...
        link_appearance: Extract<
            Appearance,
            "accent" | "subdued" | "info" | "success" | "warning" | "critical" | "decorative"
        >;
        text_size: TextSize;
    }> = useSettings();
    ...
    if (errorState) {
        ...
        return <Banner status="critical" title={errorState} />;
    }
            ...
            <BlockStack spacing="base">
                <View>
                    {step === "completed-success" && (
                        <Banner status="success" title={translate("success.discount-applied")} />
                    )}
